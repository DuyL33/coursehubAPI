...
public class ReviewController {
    ...
    public ResponseEntity<Review> createReview(@RequestBody Map<String, String> payload) {
        ...
        return new ResponseEntity<Review>(service.createReview(payload.get("grade"), payload.get("professor"), payload.get("semester"), payload.get("year") ,payload.get("difficulty"), payload.get("courseWork") ,payload.get("body"), payload.get("number")), HttpStatus.OK);
    }
    @GetMapping("/{created}")
